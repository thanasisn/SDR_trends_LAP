...
of the CUSUMs, we created another set of CUSUM plots by subtracting the corresponding long term trend from the SDR anomaly data, prior to the CUSUM calculation (Figure\ \ref{fig:cusumnotrendmonthly}).
...
## numeric precision
spp$Tlm_Std..Error  <- signif(spp$Tlm_Std..Error * 2, 3)
...
A smaller trend has
been found under clear-sky conditions ($`r cleartrend`\,\%/y$) that further supports the assumption that the brightening is caused mainly by decreasing aerosols.
