...
```{r trendALL, echo=F, fig.cap="Anomaly (\\%) of the daily Global radiation relative to climatological values for 1993 - 2023. The black line shows the long term trend for all-sky conditions."}
...
```{r trendCLOUD, echo=F, fig.cap="Anomaly (\\%) of the daily Global radiation relative to climatological values for 1993 - 2023. The black line shows the long term trend for cloud-sky conditions."}
...
rownames(LT) <- NULL
names(LT) <- c("Trend %/year", "Trend p-value", "Sky condition", "Trend statistical significance")
...
The increasing of this trend shows that the phenomenon and probably the causes have been amplified.
