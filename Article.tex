...
\Author{Athanasios Natsis$^{}$, Alkiviadis Bais$^{}$}
...
% Keywords
\keyword{GHISDRSolar Brigthening/Dimming}
...
\(\text{w}\,\text{m}^{-2}\) and \(\theta\) is the solar zenith angle
(SZA).
