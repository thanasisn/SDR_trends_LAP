...
In the final \hl{dataset \(23.3\%\) of the 1-minute data were identified
as under clear-sky conditions and} \(43\%\) \hl{as} under cloud-sky
conditions.
...
seasonal dependencies of the minimum SZA (see Appendix,
Figure~\ref{fig:SZAtrendSeason}), these dependencies would not be
further examined here. For all-sky and clear-sky conditions the
...
\citep{Wang2021}. For cloudy-sky conditions
