...
\toprule
\textbf{Sky Condition} & \textbf{Season} & \textbf{Trend [\%/year]} & \textbf{Trend S.E. ($2\sigma$)} & \textbf{Pearson Correl.} & \textbf{Trend p-Value}\\
\midrule
...
(brightening). A previous study \citep{Bais2013} for the period
1993--2011 also reported a positive trend of \(0.33\,\%/y\). The slight
...
attribution and quantification of the effects of these factors on SDR.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\authorcontributions{Conceptualization, methodology, software, data
analysis and original writing---draft preparation A.N.; writing---review
and editing, supervision, A.B.; data curation, C.M. All authors have
