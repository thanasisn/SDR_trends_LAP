...
all sky conditions by examining the cumulative sums of monthly anomalies
...
database \url{http://http://wrdc.mgo.rssi.ru}. One minute data are
available on request from the corresponding author. The data are not
publicly available for protection against unmonitored commercial use.}
