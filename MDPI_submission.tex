...
step of our measurements. In the final dataset \(40.1\%\) of the
1-minute data were identified as under clear-sky conditions and
\(59.9\%\) as under cloud-sky conditions.
...
smaller trend for clear-skies (\(0.16\,\%/y\)) and a negative weaker
trend for cloudy-skies (\(0.019\,\%/y\)). In the studied period, there
...
\begin{tabu} to \linewidth {>{\centering\arraybackslash}p{8em}>{\raggedleft}X>{\raggedleft}X>{\raggedleft}X>{\centering}X>{\raggedleft}X>{\raggedleft}X>{\raggedleft}X>{\centering}X}
\toprule
slope & slope.p & Rsqrd & RsqrdAdj & cor.t & cor.esimate & DATA & N & slope.stat\_sig\\
\midrule
0.376 & 0.00e+00 & 0.0083302 & 0.0082334 & 9.279 & 0.091270 & All skies & 10252 & 100.00\\
0.156 & 7.00e-07 & 0.0030928 & 0.0029676 & 4.971 & 0.055613 & Clear skies & 7967 & 100.00\\
0.019 & 7.23e-01 & 0.0000123 & -0.0000858 & 0.354 & 0.003506 & Cloudy skies & 10194 & 27.66\\
\bottomrule
\end{tabu}
\end{table}
...
is \(0.7\,\%/y\), larger than for all-skies (\(0.69\,\%/y\)), which is
...
\begin{tabu} to \linewidth {>{\centering\arraybackslash}p{8em}>{\centering}X>{\raggedleft}X>{\raggedleft}X>{\centering}X>{\centering}X>{\raggedleft}X>{\raggedleft}X>{\centering}X}
\toprule
Trend [\%/year] & slope.p & Rsqrd & RsqrdAdj & cor.t & cor.esimate & Sky condition & Season & slope.stat\_sig\\
\midrule
\cellcolor{gray!6}{0.6870} & \cellcolor{gray!6}{1.33e-03} & \cellcolor{gray!6}{0.3121839} & \cellcolor{gray!6}{0.2876190} & \cellcolor{gray!6}{3.5649059} & \cellcolor{gray!6}{0.5587342} & \cellcolor{gray!6}{All skies} & \cellcolor{gray!6}{Winter} & \cellcolor{gray!6}{99.90}\\
\cmidrule{1-9}
0.1460 & 1.78e-01 & 0.0616942 & 0.0293388 & 1.3808581 & 0.2483832 & All skies & Spring & 82.20\\
\cmidrule{1-9}
\cellcolor{gray!6}{0.1230} & \cellcolor{gray!6}{9.61e-02} & \cellcolor{gray!6}{0.0957525} & \cellcolor{gray!6}{0.0634580} & \cellcolor{gray!6}{1.7219100} & \cellcolor{gray!6}{0.3094390} & \cellcolor{gray!6}{All skies} & \cellcolor{gray!6}{Summer} & \cellcolor{gray!6}{90.40}\\
\cmidrule{1-9}
0.4300 & 6.67e-03 & 0.2347186 & 0.2073871 & 2.9305032 & 0.4844777 & All skies & Autumn & 99.30\\
\cmidrule{1-9}
\cellcolor{gray!6}{0.6990} & \cellcolor{gray!6}{8.51e-05} & \cellcolor{gray!6}{0.4293113} & \cellcolor{gray!6}{0.4089296} & \cellcolor{gray!6}{4.5895019} & \cellcolor{gray!6}{0.6552185} & \cellcolor{gray!6}{Clear skies} & \cellcolor{gray!6}{Winter} & \cellcolor{gray!6}{100.00}\\
\cmidrule{1-9}
-0.0265 & 8.46e-01 & 0.0013302 & -0.0331066 & -0.1965409 & -0.0364724 & Clear skies & Spring & 15.40\\
\cmidrule{1-9}
\cellcolor{gray!6}{-0.1810} & \cellcolor{gray!6}{8.08e-03} & \cellcolor{gray!6}{0.2250803} & \cellcolor{gray!6}{0.1974046} & \cellcolor{gray!6}{-2.8518021} & \cellcolor{gray!6}{-0.4744263} & \cellcolor{gray!6}{Clear skies} & \cellcolor{gray!6}{Summer} & \cellcolor{gray!6}{99.20}\\
\cmidrule{1-9}
0.1260 & 2.57e-01 & 0.0455591 & 0.0114719 & 1.1560907 & 0.2134457 & Clear skies & Autumn & 74.30\\
\cmidrule{1-9}
\cellcolor{gray!6}{0.0944} & \cellcolor{gray!6}{6.13e-01} & \cellcolor{gray!6}{0.0092345} & \cellcolor{gray!6}{-0.0261500} & \cellcolor{gray!6}{0.5108573} & \cellcolor{gray!6}{0.0960962} & \cellcolor{gray!6}{Cloudy skies} & \cellcolor{gray!6}{Winter} & \cellcolor{gray!6}{38.70}\\
\cmidrule{1-9}
0.0161 & 9.09e-01 & 0.0004533 & -0.0340138 & 0.1146809 & 0.0212909 & Cloudy skies & Spring & 9.05\\
\cmidrule{1-9}
\cellcolor{gray!6}{-0.0283} & \cellcolor{gray!6}{8.07e-01} & \cellcolor{gray!6}{0.0021748} & \cellcolor{gray!6}{-0.0334619} & \cellcolor{gray!6}{-0.2470344} & \cellcolor{gray!6}{-0.0466343} & \cellcolor{gray!6}{Cloudy skies} & \cellcolor{gray!6}{Summer} & \cellcolor{gray!6}{19.30}\\
\cmidrule{1-9}
-0.0427 & 7.98e-01 & 0.0023737 & -0.0332559 & -0.2581092 & -0.0487201 & Cloudy skies & Autumn & 20.20\\
\bottomrule
\end{tabu}
\end{table}
...
conditions (\(0.16\,\%/y\)) that further supports the assumption that
...
dimming effect on SDR under cloudy-sky conditions (\(0.019\,\%/y\)),
...
trend of \(0.69\) and \(0.7\,\%/y\) for all- and clear-skies,
respectively, in contrast to spring and summer. The trends for autumn
are also significant but smaller ( \(0.43\) and \(0.13\,\%/y\) for all-
