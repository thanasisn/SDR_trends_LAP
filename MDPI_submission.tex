...
cloudy-skies. In automn, there are the next larger trends of \(0.42\)
and \(0.19\,\%/\text{year}\), for all- and cloudy-skies respectively.
The rest seasonal trends are significant smaller, close to zero, with
clear- and cloudy-skies having a negative trend for summer. The SDR
trend is increasing with increasing solar zenith angle, except under
cloudy skies where the trend is highly variable and close to zero.
...
city centre thus we expect that measurements are affected by the urban
...
There are four distinct steps in the creation of the dataset analysed
