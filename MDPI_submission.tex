...
factor that drives climate processes, energy production and can affect
...
of the solar zenith angle have also been investigated.

We have found that for all conditions the SDR trend is stronger in
winter (\(0.7\), \(0.4\) and \(0.76\,\%/\text{year}\), for all- clear-
and cloudy skies respectively). For all- and cloudy-skis, in autumn
there are the next larger trends (\(0.42\) and \(0.19\,\%/\text{year}\),
respectively), the rest cases bare a negligable seasonal trend. The SDR
trend is increasing with increasing solar zenith angle (SZA) for
all-skies, from about \(0.2\) to \(0.6\,\%/\text{year}\). For clear- and
cloudy-skies remains low, about \(0.1\) --
\(0.2\,\%/\text{year}\,\%/\text{year}\) for all SZAs below
\(\sim 75^\circ\), and rizes rapidly for the larger SZAs.

Finally, we are discussing shorter-term variations in SDR anomalies by
...
Brazil \citep{Yamasoe2021}. On global scale, artificial Intelligence
...
CM-21 pyranometer. We re-evaluated and extended the dataset used by
...
iterative process, as the original authors proposed, and are discussed
in the next section.
...
and water vapour which are the dominant factors of the SDR variability.
...
CUSUMs of the anomalies to have a symmetric `V' shape centred around the
middle of the series. This would indicate that the anomalies are evenly
distributed around the climatological mean, and for a positive uniform
trend, the first half is below and the second half above the
...
similar behaviour with some short-term differences that do not change
the overall pattern. For clear skies (Figure~\ref{fig:cusummonth-2}), a
...
quantitative conclusions. \citet{Lozano2023} reported a Cloud Radiative
Forcing (CRF) SDR trend of \(1.22\,W/m^2/y\) for the city of Granada
Spain (\(37^\circ\,10'\,\)N, \(3^\circ\,37'\,\)E, \(680\,\)m~a.s.l.). We
found a comparable result, for the same parameter, using the long term
trend of all- and clear-skies, as follows
