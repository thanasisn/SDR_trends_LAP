...
\begin{longtabu} to \linewidth {>{\centering\arraybackslash}p{8em}>{\centering}X>{\raggedleft}X>{\raggedleft}X>{\raggedleft}X>{\raggedleft}X}
...
\midrule
\endfirsthead
\caption[]{SDR linear trends of monthly anomalies for each season of the year and related statistical parameters. \textit{(continued)}}\\
\toprule
\textbf{Sky Condition} & \textbf{Season} & \textbf{Trend [\%/year]} & \textbf{Trend S.E. ($2\sigma$)} & \textbf{Pearson Correl.} & \textbf{Trend p-Value}\\
\midrule
\endhead
...
\emph{\}\{\centering\arraybackslash Cloudy skies\} \& Autumn \& 0.19 \&
0.43 \& 0.16 \& 0.384\textbackslash{}} \textbackslash end\{longtabu\}
...
trend of \(0.7\) and \(\,\%/y\) for all- and cloudy-skies, respectively,
in contrast to spring and summer. The trends for autumn are also
significant but smaller (\$\$ and \(\,\%/y\) for all- and cloudy-skies,
respectively). The trend for clear skies is largest in winter
(\(\,\%/y\)) and negligible in spring, summer and autumn.
