...
cloudy-skies. The next larger seasonal trends are in automn \(0.42\) and
\(0.19\,\%/\text{year}\), for all- and cloudy-skies respectively. The
rest seasonal trends are significant smaller, close to zero, with a
...
where the trend is highly variable and close to zero. Finally, we are
discussing shorter-term variations in SDR anomalies by examining the
...
\(0.96\,W/m^3/y\). This estimate is similar to the cloud radiative
