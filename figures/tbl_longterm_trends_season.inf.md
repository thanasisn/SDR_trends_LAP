...
Object name:    object      
Date written:   2023-03-26 06:27:57.6 UTC  
...
Classes 'data.table' and 'data.frame':	24 obs. of  7 variables:
 ...
 $ slope.sd      : num  3.071 1.073 1.268 3.104 0.201 ...
 $ slope.p       : num  0.511556 0.252551 0.574671 0.699797 0.000327 ...
 ...
 $ slope.stat_sig: num  48.8 74.7 42.5 30 100 ...
...
---------------
 Data Summary.
---------------[1] "\n\n  * **slope**:\n\n\n    |   Min. | 1st Qu. | Median |  Mean | 3rd Qu. |  Max. |\n    |-------:|--------:|-------:|------:|--------:|------:|\n    | -2.972 |  0.1256 |  0.454 | 1.016 |  0.8837 | 7.838 |\n\n  * **slope.sd**:\n\n\n    |    Min. | 1st Qu. | Median |   Mean | 3rd Qu. |  Max. |\n    |--------:|--------:|-------:|-------:|--------:|------:|\n    | 0.04272 |   0.116 | 0.3153 | 0.8992 |   1.319 | 4.572 |\n\n  * **slope.p**:\n\n\n    |      Min. | 1st Qu. | Median |   Mean | 3rd Qu. |   Max. |\n    |----------:|--------:|-------:|-------:|--------:|-------:|\n    | 0.0001417 | 0.00994 | 0.1144 | 0.2063 |  0.4058 | 0.6998 |\n\n  * **DATA**:\n\n\n    | Length |     Class |      Mode |\n    |-------:|----------:|----------:|\n    |     24 | character | character |\n\n  * **Season**:\n\n\n    | Length |     Class |      Mode |\n    |-------:|----------:|----------:|\n    |     24 | character | character |\n\n  * **var**:\n\n\n    | Length |     Class |      Mode |\n    |-------:|----------:|----------:|\n    |     24 | character | character |\n\n  * **slope.stat_sig**:\n\n\n    |  Min. | 1st Qu. | Median |  Mean | 3rd Qu. |  Max. |\n    |------:|--------:|-------:|------:|--------:|------:|\n    | 30.02 |   59.42 |  88.56 | 79.37 |   99.01 | 99.99 |\n\n\n<!-- end of list -->\n\n\n"
attr(,"class")
[1] "knit_asis"
attr(,"knit_cacheable")
[1] NA
