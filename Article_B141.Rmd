...
```{r szatrends, echo = FALSE, fig.cap='Distribution of the SDR\'s long term trends by SZA.', fig.subcap=c('Trend distribution for all-sky conditions.', 'Trend distribution for cloud-sky conditions.'), out.width='.34\\linewidth', fig.asp=1, fig.ncol = 2}
knitr::include_graphics(c("./images/SzaTrends-13.pdf", "./images/SzaTrends-21.pdf"))
```
