...
\Author{Athanasios
Natsis$^{1,2,\ddagger,*}$\href{https://orcid.org/0000-0002-5199-4119}
{\orcidicon}, Alkiviadis Bais$^{2, \dagger,}$}
...
Country; \href{mailto:abais@auth.gr}{\nolinkurl{abais@auth.gr}}\\
}
...
\begin{figure}
\centering
\includegraphics{MDPI_submition_files/figure-latex/fig1-1.pdf}
