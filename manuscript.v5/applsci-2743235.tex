...
{\orcidicon}, Alkiviadis Bais \href{https://orcid.org/0000-0003-3899-2001}
...
\begin{figure}[H]
    \begin{adjustwidth}{-\extralength}{0cm}
       ...
       % \subfloat[\label{fig:cusummonth-2}]
        ...
        \subfloat[\label{fig:cusummonth-3}]
            {\includegraphics[width=.32\linewidth]{./images/CumulativeMonthlyCuSum-9}}\hfill
        }
\end{adjustwidth}
\caption{\hl{Cumulative} %MDPI: We moved the subfigure explanations into the figure caption. Please confirm.
...
\begin{figure}[H]
    ...
    \end{adjustwidth}
        \caption{\hl{Long} %MDPI: We removed duplicate explanation in figure.
...
\begin{figure}[H]
    ...
    \end{adjustwidth}
 \caption{\colorbox{red}{Monthly} %MDPI: Please add the explanation for subfifgures in the figure.
