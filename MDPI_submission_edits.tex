...
%DIF ADD MDPI_submission.tex                 Sat Dec  2 21:48:08 2023
...
step of our measurements. In the final dataset \DIFdelbegin \DIFdel{\(84.2\%\) of the }\DIFdelend \DIFaddbegin \DIFadd{\(NA\%\) of the 1-minute
}\DIFaddend data were identified as under clear-sky conditions and \DIFdelbegin \DIFdel{\(15.8\%\) }\DIFdelend \DIFaddbegin \DIFadd{\(NA\%\) }\DIFaddend as under
...
smaller trend for clear-skies (\DIFdelbegin \DIFdel{\(0.35\,\%/y\)}\DIFdelend \DIFaddbegin \DIFadd{\(0.041\,\%/y\)}\DIFaddend ) and a negative weaker
...
\DIFdelFL{\%}%DIFDELCMD < ] %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Rsqrd }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{Days with data}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{RsqrdAdj }& \DIFaddFL{cor.t }& \DIFaddFL{cor.estimate }& \DIFaddFL{DATA }& \DIFaddFL{N }& \DIFaddFL{slope.stat\_sig}\DIFaddendFL \\
\midrule
\DIFaddbeginFL \DIFaddFL{0.3760 }& \DIFaddFL{0.0000 }& \DIFaddFL{0.008339 }& \DIFaddFL{0.0082421 }& \DIFaddFL{9.284 }& \DIFaddFL{0.09132 }& \DIFaddendFL All skies & \DIFdelbeginFL \DIFdelFL{0.376 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{10251 }\DIFaddendFL & 100.00\DIFdelbeginFL %DIFDELCMD < & %%%
\DIFdelFL{10256}\DIFdelendFL \\
\DIFdelbeginFL \DIFdelFL{Clear skies }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.3430 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{0.349 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.0000 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{100.00 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.005312 }& \DIFaddFL{0.0051756 }& \DIFaddFL{6.234 }& \DIFaddFL{0.07289 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{10256}%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdelendFL Cloudy skies & \DIFdelbeginFL \DIFdelFL{-0.276 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{7279 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{99.97 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{100.00}\\
\DIFaddFL{0.0406 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{5067}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.0141 }& \DIFaddFL{0.001195 }& \DIFaddFL{0.0009971 }& \DIFaddFL{2.455 }& \DIFaddFL{0.03458 }& \DIFaddFL{Clear skies }& \DIFaddFL{5036 }& \DIFaddFL{98.59}\DIFaddendFL \\
\bottomrule
\end{tabu}
\end{table}
...
\DIFdelFL{\%}%DIFDELCMD < ]%%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{slope.p }& \DIFaddFL{Rsqrd }& \DIFaddFL{RsqrdAdj }& \DIFaddFL{cor.t }& \DIFaddFL{cor.estimate }& \DIFaddFL{Sky condition }& \DIFaddFL{Season }& \DIFaddFL{slope.stat\_sig}\DIFaddendFL \\
\midrule
...
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.001330} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{0.6860} %%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.3121839} & \cellcolor{gray!6}{0.2876190} & \cellcolor{gray!6}{3.564906} & \cellcolor{gray!6}{0.5587342} & \cellcolor{gray!6}{All skies} & \cellcolor{gray!6}{Winter} \DIFaddendFL & \cellcolor{gray!6}{99.9}\\
\DIFdelbeginFL %DIFDELCMD < 

%DIFDELCMD <  %%%
\DIFdelendFL \DIFaddbeginFL \cmidrule{1-9}
\DIFaddFL{0.1460 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{Spring }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.178000 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{0.1450 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.0616942 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{81.8}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.0293388 }& \DIFaddFL{1.380858 }& \DIFaddFL{0.2483832 }& \DIFaddFL{All skies }& \DIFaddFL{Spring }& \DIFaddFL{82.2}\DIFaddendFL \\
\DIFdelbeginFL %DIFDELCMD < 

%DIFDELCMD < \cellcolor{gray!6}{} %%%
\DIFdelendFL \DIFaddbeginFL \cmidrule{1-9}
\cellcolor{gray!6}{0.1230} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{Summer} %%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.096100} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{0.1200} %%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.0957525} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{89.4}%%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.0634580} & \cellcolor{gray!6}{1.721910} & \cellcolor{gray!6}{0.3094390} & \cellcolor{gray!6}{All skies} & \cellcolor{gray!6}{Summer} & \cellcolor{gray!6}{90.4}\DIFaddendFL \\
\DIFdelbeginFL %DIFDELCMD < 

%DIFDELCMD < \multirow{-4}{*}{\centering\arraybackslash All skies} %%%
\DIFdelendFL \DIFaddbeginFL \cmidrule{1-9}
\DIFaddFL{0.4300 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{Autumn }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.006670 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{0.4310 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.2347063 }& \DIFaddFL{0.2073744 }& \DIFaddFL{2.930403 }& \DIFaddFL{0.4844650 }& \DIFaddFL{All skies }& \DIFaddFL{Autumn }\DIFaddendFL & 99.3\\
\DIFdelbeginFL %DIFDELCMD < \cmidrule{1-4}
%DIFDELCMD < \cellcolor{gray!6}{} %%%
\DIFdelendFL \DIFaddbeginFL \cmidrule{1-9}
\cellcolor{gray!6}{0.4990} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{Winter} %%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.000166} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{0.8260} %%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.4025975} & \cellcolor{gray!6}{0.3812617} & \cellcolor{gray!6}{4.343912} & \cellcolor{gray!6}{0.6345057} & \cellcolor{gray!6}{Clear skies} & \cellcolor{gray!6}{Winter} \DIFaddendFL & \cellcolor{gray!6}{100.0}\\
\DIFdelbeginFL %DIFDELCMD < 

%DIFDELCMD <  %%%
\DIFdelendFL \DIFaddbeginFL \cmidrule{1-9}
\DIFaddFL{-0.0865 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{Spring }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.315000 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{0.0613 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.0348099 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{38.6}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.0015275 }& \DIFaddFL{-1.022690 }& \DIFaddFL{-0.1865741 }& \DIFaddFL{Clear skies }& \DIFaddFL{Spring }& \DIFaddFL{68.5}\DIFaddendFL \\
\DIFdelbeginFL %DIFDELCMD < 

%DIFDELCMD < \cellcolor{gray!6}{} %%%
\DIFdelendFL \DIFaddbeginFL \cmidrule{1-9}
\cellcolor{gray!6}{-0.2180} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{Summer} %%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.000398} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{-0.0307} %%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.3659586} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{25.9}%%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.3433142} & \cellcolor{gray!6}{-4.020094} & \cellcolor{gray!6}{-0.6049451} & \cellcolor{gray!6}{Clear skies} & \cellcolor{gray!6}{Summer} & \cellcolor{gray!6}{100.0}\DIFaddendFL \\
\DIFdelbeginFL %DIFDELCMD < 

%DIFDELCMD < \multirow{-4}{*}{\centering\arraybackslash Clear skies} %%%
\DIFdelendFL \DIFaddbeginFL \cmidrule{1-9}
\DIFaddFL{0.1090 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{Autumn }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.221000 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{0.3670 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.0529350 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{97.2}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.0191112 }& \DIFaddFL{1.251009 }& \DIFaddFL{0.2300761 }& \DIFaddFL{Clear skies }& \DIFaddFL{Autumn }& \DIFaddFL{77.9}\DIFaddendFL \\
\DIFdelbeginFL %DIFDELCMD < \cmidrule{1-4}
%DIFDELCMD < \cellcolor{gray!6}{} %%%
\DIFdelendFL \DIFaddbeginFL \cmidrule{1-9}
\cellcolor{gray!6}{0.5200} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{Winter} %%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.009580} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{-0.8820} %%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.2164332} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{98.9}%%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.1884487} & \cellcolor{gray!6}{2.781012} & \cellcolor{gray!6}{0.4652238} & \cellcolor{gray!6}{Cloudy skies} & \cellcolor{gray!6}{Winter} & \cellcolor{gray!6}{99.0}\DIFaddendFL \\
\DIFdelbeginFL %DIFDELCMD < 

%DIFDELCMD <  %%%
\DIFdelendFL \DIFaddbeginFL \cmidrule{1-9}
\DIFaddFL{0.1780 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{Spring }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.122000 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{-0.0991 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.0806332 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{37.2}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.0489309 }& \DIFaddFL{1.594819 }& \DIFaddFL{0.2839598 }& \DIFaddFL{Cloudy skies }& \DIFaddFL{Spring }& \DIFaddFL{87.8}\DIFaddendFL \\
\DIFdelbeginFL %DIFDELCMD < 

%DIFDELCMD < \cellcolor{gray!6}{} %%%
\DIFdelendFL \DIFaddbeginFL \cmidrule{1-9}
\cellcolor{gray!6}{0.1940} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{Summer} %%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.036800} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{0.0444} %%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.1466137} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{21.5}%%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.1161356} & \cellcolor{gray!6}{2.193277} & \cellcolor{gray!6}{0.3829017} & \cellcolor{gray!6}{Cloudy skies} & \cellcolor{gray!6}{Summer} & \cellcolor{gray!6}{96.3}\DIFaddendFL \\
\DIFdelbeginFL %DIFDELCMD < 

%DIFDELCMD < \multirow{-4}{*}{\centering\arraybackslash Cloudy skies} %%%
\DIFdelendFL \DIFaddbeginFL \cmidrule{1-9}
\DIFaddFL{0.3470 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{Autumn }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.100000 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{-0.4000 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.0934930 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{89.5}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.0611177 }& \DIFaddFL{1.699350 }& \DIFaddFL{0.3057662 }& \DIFaddFL{Cloudy skies }& \DIFaddFL{Autumn }& \DIFaddFL{90.0}\DIFaddendFL \\
\bottomrule
\end{tabu}
\end{table}
...
conditions (\DIFdelbegin \DIFdel{\(0.35\,\%/y\)}\DIFdelend \DIFaddbegin \DIFadd{\(0.041\,\%/y\)}\DIFaddend ) that further supports the assumption that
