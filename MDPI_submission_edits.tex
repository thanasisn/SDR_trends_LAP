...
%DIF ADD MDPI_submission.tex                 Thu Dec 28 19:13:56 2023
...
}\DIFaddend \ref{fig:trendCLOUD} in Appendix) \DIFdelbegin \DIFdel{, }\DIFdelend shows a rather homogeneous \DIFdelbegin \DIFdel{behaviour}\DIFdelend \DIFaddbegin \DIFadd{behavior}\DIFaddend ,
...
SDR. From 1997 to mid-2000s CUSUMs are increasing, likely due to a continuous decrease in the optical thickness of clouds, followed by a
period of rapid increase (within 3 years) in
cloud optical thickness
lasting up to 2008. The following stable period spans for about 15 years
up to 2021 when CUSUMs start increasing again
}\DIFdelend \DIFaddbegin \DIFadd{\ref{fig:cusumnotrendmonthly-2}) the distinct change
...
illustrated in Figure 7 of \mbox{%DIFAUXCMD
...
\DIFadd{Under clear skies (Figure~\ref{fig:szatrends-2}), the trends are smaller
