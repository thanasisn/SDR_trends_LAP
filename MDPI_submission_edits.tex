...
%DIF ADD ./MDPI_submission.tex                 Thu Nov 30 05:11:29 2023
...
%DIF > Warning in set(x, j = name, value = value): Column 'cor.null_value' does not
%DIF > exist to remove
\end{DIFverbatim}
\DIFmodend
...
\DIFmodbegin
\begin{DIFverbatim}[alsolanguage=DIFcode]
%DIF > Warning in set(x, j = name, value = value): Column 'cor.alternative' does not
%DIF > exist to remove
\end{DIFverbatim}
\DIFmodend
...
\DIFmodbegin
\begin{DIFverbatim}[alsolanguage=DIFcode]
%DIF > Warning in set(x, j = name, value = value): Column 'cor.method' does not exist
%DIF > to remove
\end{DIFverbatim}
\DIFmodend
...
\DIFmodbegin
\begin{DIFverbatim}[alsolanguage=DIFcode]
%DIF > Warning in set(x, j = name, value = value): Column 'cor.data_name' does not
%DIF > exist to remove
\end{DIFverbatim}
\DIFmodend
...
\DIFmodbegin
\begin{DIFverbatim}[alsolanguage=DIFcode]
%DIF > Warning in set(x, j = name, value = value): Column 'cor.p' does not exist to
%DIF > remove
\end{DIFverbatim}
\DIFmodend
...
\DIFaddend We calculated the linear SDR trends, from the departures of the mean
...
\midrule
\DIFaddbeginFL \DIFaddFL{0.376 }& \DIFaddFL{0.00000 }& \DIFaddFL{0.008308 }& \DIFaddFL{0.008211 }& \DIFaddFL{9.268 }& \DIFaddFL{0.09115 }& \DIFaddendFL All skies & \DIFdelbeginFL \DIFdelFL{0.376 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{10256 }\DIFaddendFL & 100.00\DIFdelbeginFL %DIFDELCMD < & %%%
\DIFdelFL{10256}\DIFdelendFL \\
\DIFaddbeginFL \DIFaddFL{0.349 }& \DIFaddFL{0.00000 }& \DIFaddFL{0.006183 }& \DIFaddFL{0.006087 }& \DIFaddFL{7.987 }& \DIFaddFL{0.07864 }& \DIFaddendFL Clear skies & \DIFdelbeginFL \DIFdelFL{0.349 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{10256 }\DIFaddendFL & 100.00\DIFdelbeginFL %DIFDELCMD < & %%%
\DIFdelFL{10256}\DIFdelendFL \\
\DIFaddbeginFL \DIFaddFL{-0.276 }& \DIFaddFL{0.00026 }& \DIFaddFL{0.002631 }& \DIFaddFL{0.002434 }& \DIFaddFL{-3.655 }& \DIFaddFL{-0.05129 }& \DIFaddendFL Cloudy skies & \DIFdelbeginFL \DIFdelFL{-0.276 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{5067 }\DIFaddendFL & 99.97\DIFdelbeginFL %DIFDELCMD < & %%%
\DIFdelFL{5067}\DIFdelendFL \\
\bottomrule
\end{tabu}
\end{table}
...
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.6860} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{Winter} %%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.001300} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{0.6860} %%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.3133809} & \cellcolor{gray!6}{0.2888588} & \cellcolor{gray!6}{3.5748458} & \cellcolor{gray!6}{0.5598043} & \cellcolor{gray!6}{All skies} & \cellcolor{gray!6}{Winter} \DIFaddendFL & \cellcolor{gray!6}{99.9}\\
\DIFdelbeginFL %DIFDELCMD < 

%DIFDELCMD <  %%%
\DIFdelendFL \DIFaddbeginFL \cmidrule{1-9}
\DIFaddFL{0.1450 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{Spring }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.182000 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{0.1450 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.0605222 }& \DIFaddFL{0.0281264 }& \DIFaddFL{1.3668258 }& \DIFaddFL{0.2460126 }& \DIFaddFL{All skies }& \DIFaddFL{Spring }\DIFaddendFL & 81.8\\
\DIFdelbeginFL %DIFDELCMD < 

%DIFDELCMD < \cellcolor{gray!6}{} %%%
\DIFdelendFL \DIFaddbeginFL \cmidrule{1-9}
\cellcolor{gray!6}{0.1200} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{Summer} %%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.106000} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{0.1200} %%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.0904804} & \cellcolor{gray!6}{0.0579975} & \cellcolor{gray!6}{1.6689762} & \cellcolor{gray!6}{0.3007995} & \cellcolor{gray!6}{All skies} & \cellcolor{gray!6}{Summer} \DIFaddendFL & \cellcolor{gray!6}{89.4}\\
\DIFdelbeginFL %DIFDELCMD < 

%DIFDELCMD < \multirow{-4}{*}{\centering\arraybackslash All skies} %%%
\DIFdelendFL \DIFaddbeginFL \cmidrule{1-9}
\DIFaddFL{0.4310 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{Autumn }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.006650 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{0.4310 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.2348722 }& \DIFaddFL{0.2075462 }& \DIFaddFL{2.9317564 }& \DIFaddFL{0.4846362 }& \DIFaddFL{All skies }& \DIFaddFL{Autumn }\DIFaddendFL & 99.3\\
\DIFdelbeginFL %DIFDELCMD < \cmidrule{1-4}
%DIFDELCMD < \cellcolor{gray!6}{} %%%
\DIFdelendFL \DIFaddbeginFL \cmidrule{1-9}
\cellcolor{gray!6}{0.8260} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{Winter} %%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.000259} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{0.8260} %%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.3841800} & \cellcolor{gray!6}{0.3621864} & \cellcolor{gray!6}{4.1794536} & \cellcolor{gray!6}{0.6198226} & \cellcolor{gray!6}{Clear skies} & \cellcolor{gray!6}{Winter} \DIFaddendFL & \cellcolor{gray!6}{100.0}\\
\DIFdelbeginFL %DIFDELCMD < 

%DIFDELCMD <  %%%
\DIFdelendFL \DIFaddbeginFL \cmidrule{1-9}
\DIFaddFL{0.0613 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{Spring }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.614000 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{0.0613 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.0088730 }& \DIFaddFL{-0.0253038 }& \DIFaddFL{0.5095289 }& \DIFaddFL{0.0941964 }& \DIFaddFL{Clear skies }& \DIFaddFL{Spring }\DIFaddendFL & 38.6\\
\DIFdelbeginFL %DIFDELCMD < 

%DIFDELCMD < \cellcolor{gray!6}{} %%%
\DIFdelendFL \DIFaddbeginFL \cmidrule{1-9}
\cellcolor{gray!6}{-0.0307} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{Summer} %%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.741000} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{-0.0307} %%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.0039765} & \cellcolor{gray!6}{-0.0315958} & \cellcolor{gray!6}{-0.3343454} & \cellcolor{gray!6}{-0.0630596} & \cellcolor{gray!6}{Clear skies} & \cellcolor{gray!6}{Summer} \DIFaddendFL & \cellcolor{gray!6}{25.9}\\
\DIFdelbeginFL %DIFDELCMD < 

%DIFDELCMD < \multirow{-4}{*}{\centering\arraybackslash Clear skies} %%%
\DIFdelendFL \DIFaddbeginFL \cmidrule{1-9}
\DIFaddFL{0.3670 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{Autumn }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.028300 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{0.3670 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.1603773 }& \DIFaddFL{0.1303908 }& \DIFaddFL{2.3126418 }& \DIFaddFL{0.4004713 }& \DIFaddFL{Clear skies }& \DIFaddFL{Autumn }\DIFaddendFL & 97.2\\
\DIFdelbeginFL %DIFDELCMD < \cmidrule{1-4}
%DIFDELCMD < \cellcolor{gray!6}{} %%%
\DIFdelendFL \DIFaddbeginFL \cmidrule{1-9}
\cellcolor{gray!6}{-0.8820} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{Winter} %%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.011100} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{-0.8820} %%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.2089717} & \cellcolor{gray!6}{0.1807207} & \cellcolor{gray!6}{-2.7197359} & \cellcolor{gray!6}{-0.4571342} & \cellcolor{gray!6}{Cloudy skies} & \cellcolor{gray!6}{Winter} \DIFaddendFL & \cellcolor{gray!6}{98.9}\\
\DIFdelbeginFL %DIFDELCMD < 

%DIFDELCMD <  %%%
\DIFdelendFL \DIFaddbeginFL \cmidrule{1-9}
\DIFaddFL{-0.0991 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{Spring }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.628000 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{-0.0991 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.0081869 }& \DIFaddFL{-0.0260136 }& \DIFaddFL{-0.4892643 }& \DIFaddFL{-0.0904814 }& \DIFaddFL{Cloudy skies }& \DIFaddFL{Spring }\DIFaddendFL & 37.2\\
\DIFdelbeginFL %DIFDELCMD < 

%DIFDELCMD < \cellcolor{gray!6}{} %%%
\DIFdelendFL \DIFaddbeginFL \cmidrule{1-9}
\cellcolor{gray!6}{0.0444} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{Summer} %%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.785000} \DIFaddendFL & \DIFdelbeginFL %DIFDELCMD < \cellcolor{gray!6}{0.0444} %%%
\DIFdelendFL \DIFaddbeginFL \cellcolor{gray!6}{0.0026952} & \cellcolor{gray!6}{-0.0329228} & \cellcolor{gray!6}{0.2750824} & \cellcolor{gray!6}{0.0519156} & \cellcolor{gray!6}{Cloudy skies} & \cellcolor{gray!6}{Summer} \DIFaddendFL & \cellcolor{gray!6}{21.5}\\
\DIFdelbeginFL %DIFDELCMD < 

%DIFDELCMD < \multirow{-4}{*}{\centering\arraybackslash Cloudy skies} %%%
\DIFdelendFL \DIFaddbeginFL \cmidrule{1-9}
\DIFaddFL{-0.4000 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{Autumn }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.105000 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{-0.4000 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.0912639 }& \DIFaddFL{0.0588091 }& \DIFaddFL{-1.6769099 }& \DIFaddFL{-0.3020992 }& \DIFaddFL{Cloudy skies }& \DIFaddFL{Autumn }\DIFaddendFL & 89.5\\
\bottomrule
\end{tabu}
\end{table}
