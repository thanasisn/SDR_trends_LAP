...
if (havetorun) {
    ...
    ## flag with better season!!

    ## Quarter of year with one month shift
      ALL_1_daily_mean[, season_qrt := as.yearqtr(as.yearmon(paste(year(Date), month(Date), sep = "-")) + 1/12)]
    CLEAR_1_daily_mean[, season_qrt := as.yearqtr(as.yearmon(paste(year(Date), month(Date), sep = "-")) + 1/12)]
    CLOUD_1_daily_mean[, season_qrt := as.yearqtr(as.yearmon(paste(year(Date), month(Date), sep = "-")) + 1/12)]
