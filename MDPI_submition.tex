...
We have demonstrated that in the period 1993 - 2023, there is positive
trend in SDR of for all-sky conditions (\(0.38\,\%/y\)). A previous
study \citep{Bais2013} for the period 1993 - 2011 the trend was found to
be \(0.33\,\%/y\). The increase of this trend, indicates that the
...
\citet{Wild2021}. The dimming effect on SDR under cloudy-sky conditions
(\(-0.28\,\%/y\)),suggests that cloud optical thickness is decreasing
during this period. Because we have no adequate data to investigate the
long term changes of cloud thickness in the region, we can not verify if
