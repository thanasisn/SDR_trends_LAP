...
We have to note also, that despite the capability of the CSid to use the DNI as a characterization parameter, we haven't used it, to avoid any selection bias due to unequal availability of measurements.
...
<!-- dark correction -->
The measurements were corrected for the zero offset of the instrument signal.
...
Where, after an iterative optimization of eight simple models (Daneshyar–Paltridge–Proctor, Kasten–Czeplak, Haurwitz, Berger–Duffie, Adnot–Bourges–Campana–Gicquel, Robledo-Soler, Kasten and Ineichen-Perez) with a wide range factors.
We found, that Haurwitz’s model, adjusted with a factor of `r signif(alpha,3)` has one of the lowest root mean squared error (RMSE), while retains most of our data. 
