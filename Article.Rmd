...
Although the trends suggest that raw data have an homogeneous behavior, using plots of the cumulative sum (CUSUM) of the computed anomalies, we can reveal some structure within the trends and some differences between the sky conditions [@Regier2019]. 
