...
<!-- aggregation -->
In order to investigate the SDR trends, we implemented an appropriate aggregation scheme to the 1-minute data to derive a series in coarser time scale.
...
Accordingly, we found a similar trend for Clear-sky conditions ($`r cleartrend`\%/year$) that further supports that the brightening can be independent from the cloud occurrences. 
