...
In order to estimate the contribution of the SZA, we group the anomaly data in $1^\circ$ SZA bins, and calculated the overall trend for each bin (Figures\ \ref{fig:szatrends}a and \ref{fig:szatrends}b).
Although there is a seasonal change of SZA limits than is not represented here, the brightening effect of SDR is stronger for All-sky and Clear-sky condition for low Sun elevation angles.
