...
See Figures \ref{fig:szatrends}a and \ref{fig:szatrends}b

```{r szatrends, echo = FALSE, fig.cap='two plots', fig.subcap=c('one plot', 'the other one'), out.width='.35\\linewidth', fig.asp=1, fig.ncol = 2}
knitr::include_graphics(c("./images/SzaTrends-5.pdf", "./images/SzaTrends-21.pdf"))
```
