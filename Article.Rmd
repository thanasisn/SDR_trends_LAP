...
<!-- Trends -->
A general dimming before 2000 and a brightening afterwards, was found on multiple station in China [@Yang2021]. 
And a similar pattern was identified, with the breaking point around 1980, from a 71 years record of a Central Europe station [@Wild2021] and for Brazil [@Yamasoe2021].
...
Those interactions, among other factors, have been analysed with modeling [@Li2016; @Samset2018], showing the existence of feedback mechanisms between the two.
...
Due to the variability of the phenomenon, and its contributing factors, there is a need to further investigate SDR tendencies, in different sites, to estimate its magnitude, and its relation to the local conditions.
