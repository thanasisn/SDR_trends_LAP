...
Other studies for the European region are reporting a change of the SDR slope, around the 1980, few years before the start of our records [@Wild2021; @Yuan2021; @Ohmura2009]. It is interesting to note, that for the observation period, the trend of the TSI is $`r format(TSIslopeAll[1,1], scientific = T, digits = 2)`\%/year$.
