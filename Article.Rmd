...
The increase of this trend, indicates that the phenomenon and probably the causes, still persists.
...
Although, we have no adequate data to investigate long term changes of cloud formation in the region, in order to infer if the SDR trend we observe under Cloud-sky is biased by those changes.

Brightening is driven during Winter and Summer
