...
The target of the optimization was the minimizing of the function .......



\begin{equation}
f(a)=\frac{1}{n}\sum_{i=1}^{n}( \text{SDR}_{\text{meas},CS,i} - a \times \text{SDR}_{\text{ref},CS,i})^2
\end{equation}
...
Of the total 1-minute measurements
$`r signif(100 * SDR_N_Clear / SDR_N_All, 3)`\%$ 
is characterized with clear-sky conditon, and the rest 
...
${MSE}={Cost}=\frac{1}{n}\sum_{i=1}^{n}(A_i - B_i)^2$
