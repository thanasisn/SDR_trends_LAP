...
In this time period, we could not find any significant break or change in the variability of the trends.
Other studies for the European region are reporting a change of the SDR slope, around the '80, few years before the start of our records [@Wild2021; @Yuan2021; @Ohmura2009].
...
```{r cumsum, echo = FALSE, fig.cap='two plots', fig.subcap=c('one plot', 'the other one'), out.width='.32\\linewidth', fig.asp=1, fig.ncol = 3}
