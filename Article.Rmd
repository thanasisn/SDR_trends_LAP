...
The interaction between Aerosols and clouds, among other factors, has been analysed with modeling [@Li2016; @Samset2018], showing the existence of feedback mechanisms between the two.

Similar links have been showed with observational data [@Ohvril2009; @Schwarz2020; ]
...
Multiple studies attempt to evaluate the phenomenon and the potential causes [;  @Wild2012; @Xia2007; @Zerefos2009; and references therein].
<!-- causes say less we don't do that -->


Investigate multiple interaction @Li2016 @Samset2018 data analysis and modeling
