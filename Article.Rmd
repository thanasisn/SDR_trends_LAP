...
[??]{.comment-start id="0" author="Alkis Bais"
date="2023-07-14T07:52:00Z"}CSid algorithm[]{.comment-end id="0"}, along
with the site specific thresholds.
To calculate the reference clear sky
SDR~CSref~ we used the [Not visible equation]{.comment-start id="2"
