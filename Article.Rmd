...
While in Spring and Summer the brightening of the SDR seem to be very low, although the statistical significance is now adequate for all cases, there are significant changes in Winter and Autumn
(Figure\ \ref{fig:seasonalALL} and Table\ \ref{tab:trendseasontable}).
Especially for winter and 
