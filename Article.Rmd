...
```{r trendALL, echo=F, out.width='.70\\linewidth', fig.cap="Anomaly (\\%) of the daily SDR relative to climatological values for 1993 - 2023  `r year(min(ALL_1_daily_DESEAS$Date))` to `r year(max(ALL_1_daily_DESEAS$Date))`. The black line shows the long term trend for all-sky conditions."}
