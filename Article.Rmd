...
Describe the variability of the phenomenn

the inpacts of the radiation

the as far studies/coauses




The shortwave downward solar irradiance (SDR) at the Earth's surface plays a significant role, on Earths climate.
Changes of the SDR can be related to major changes on the Earths energy budget, the climate change mechanisms and the water and carbon cycles [@Wild2009].
Studies of SDR variability, have identify some distinct SDR trends on different regions of the world and for different time periods, using the term 'brightening' for positive trends, and 'dimming' for negative trends.
...
There is a general consensus that the major factors of the attenuation of SDR is the interaction with the atmospheric aerosols and the clouds.

- observed long term changes
  europe / asia africa regions


Although, there is regional variation of SDR, with both positive and negative trends, most of the studies agree that .
