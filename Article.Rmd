...
<!-- measurement -->
We sample the signal of the CM-21 pyranometer with a rate of $1 {Hz}$, and record the average signal and the standard deviation over each minute of the hour. The measurements are corrected for the zero offset of the instrument, using the "dark signal" (Sun elevation bellow $10\circ$, for a period of
...
<!-- physical quantities -->
The conversion to irradiance was done using the available calibrations factors. For CHP-1, there is only the initial one by the manufacture, and for CM-21 there are seven calibration procedure in the span of the period we investigate.
<!-- Dark signal -->
We have adjusted the measurements for the dark signal offset, by a daily value, using the nights before and after each day.
<!-- Quality assurance -->
A radiation data quality assurance procedure was applied, adjusted for the site, based on methods of Long and Shi\ [-@long_automated_2008; -@Long2006]. Only data characterized as good quality were used in this study.
<!-- Data selection -->
