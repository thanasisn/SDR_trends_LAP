...
$`r format(TSIslopeAll[1,1], scientific = T, digits = 2)`\%/year$, and thus we can not attribute any major effect on SDR trend to Solar variability.
...
Although the trends are quite constant, using plots of the cumulative sum (CUSUM) we can reveal some structure within the trends and some differences between the sky conditions [@Regier2019]. 
...
Another distinct feature of CUSUMs, is the difference, between the cloud-sky and the rest of the sky conditions, where they display a supplementary behavior. 
...
```{r cumsum, echo = FALSE, fig.cap='Running cumulative sum plots of the daily SDR for the three different sky conditions.', fig.subcap=c('All-sky conditions.', 'Clear-sky conditions.', 'Cloud-sky conditions.'), out.width='.32\\linewidth', fig.asp=1, fig.ncol = 3}
...
```{r cumsumnotrend, echo = FALSE, fig.cap='Running cumulative sum plots of the daily SDR after removing the long term trend from the daily values, for the three different sky conditions.', fig.subcap=c('All-sky conditions.', 'Clear-sky conditions.', 'Cloud-sky conditions.'), out.width='.32\\linewidth', fig.asp=1, fig.ncol = 3}
knitr::include_graphics(c(
    "./images/CumulativeDailyCumSumNOtrend-1.png",    # ALL sky
    "./images/CumulativeDailyCumSumNOtrend-5.png",    # CLEAR sky
    "./images/CumulativeDailyCumSumNOtrend-9.png"))   # Cloud sky
```
...
For all-sky condition the trend in SDR is very significant for the Winter, close to the long term trend for the Autumn, and almost four times lower than the long term trend for Sprint and Summer, indicating a relation to the cloud pattern of each season.
...
## rename sky conditions
pp$`Sky condition` <- sub(" cond.", "", pp$`Sky condition`)
