...
stop("Observations to days of data!!")
...
x_latex <- knitr::kable(LT2,
                        ...
                        linesep  = "",
                        align    = "crr",
                        caption  = paste0("\\label{tab:trendtable}Trends in SDR daily means for different sky conditions for the period ", year(min(ALL_1_daily_DESEAS$Date)), " - ", year(max(ALL_1_daily_DESEAS$Date)), "."))
x_latex %>%
    kable_styling(
