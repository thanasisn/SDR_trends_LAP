...
rownames(LT) <- NULL
names(LT)    <- c("Trend [%/year]", "Trend p-value", "Sky conditions", "Statistical signif. [%]")
## no need all are 100%
...
In our case, for all-skies and clear-skies, we observe periods where the CUSUMs remain relative steady, roughly around the middle of the study dataset. This is an indication that the whole brightening phenomenon has not a smooth development over time.
...
Overall, for all- and clear-sky conditions (Figure\ \ref{fig:cusumnotrend-1} and\ \ref{fig:cusumnotrend-2}) we observe periods when the anomalies diverge from the climatological value, each lasting for several years. 
