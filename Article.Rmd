...
In order to compare any features within the trends, we created another set of CUSUMs plots, by subtracting the corresponding long term trend from the data, prior the CUSUM calculation (Figure\ \ref{fig:cusumnotrend}).
