...
We calculated the SDR trends, from the mean daily values of the departure from the seasonal values, for the three sky conditions (Table\ \ref{tab:trendtable}).
