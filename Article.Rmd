...
<!-- Seasonal -->
..... Define seasons aggregation if used .......
...
pp$var                <- NULL
rownames(pp) <- NULL
names(pp) <- c("Trend", "Trend p-value", "Sky condition", "Trend statistical significance")
...
```{r seasonalALL, echo=F, fig.cap="Donditions."}
knitr::include_graphics("./images/SeasonaltTrends-1.pdf")
```

```{r seasonalCLEAR, echo=F, fig.cap="Daiditions."}
knitr::include_graphics("./images/SeasonaltTrends-2.pdf")
```

```{r seasonalCLOUD, echo=F, fig.cap="Daiditions."}
...
pp$var                <- NULL
rownames(pp) <- NULL
names(pp) <- c("Trend", "Trend p-value", "Sky condition", "Season", "Trend statistical sign.")
