...
<!-- ```{r cusumnotrendmonthly, echo = FALSE, fig.cap='Running cumulative sum plots of the monthly SDR after removing the long term trend from the monthly values, for the three different sky conditions.', fig.subcap=c('All-sky conditions.', 'Clear-sky conditions.', 'Cloud-sky conditions.'), out.width='.32\\linewidth', fig.asp=1, fig.ncol = 3} -->
<!-- knitr::include_graphics(c( -->
<!--     "./images/CumulativeMonthlyCuSum",    # ALL sky -->
