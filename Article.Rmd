...
<!-- }. -->
Although, we performed similar analysis to DNI as for SDR, due to the sorter duration of the data, the results are not presented here, as they lack the appropriate statistical significance.
...
We have to note that, despite the capability of the CSid to use the DNI as an characterization parameter, 

.... wi dindnt use it  .....

but was not used as indicator of clear sky instances  
