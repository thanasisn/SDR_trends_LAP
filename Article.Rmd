...
@Yuan2021 with AI aided spatial analysis on continent level, containing numerous observational station, reach similar conclusions for the above regions and the global trend.


Although, there is a consensus, among researchers, that the major factors of the attenuation of SDR is the interaction with the atmospheric aerosols and the clouds. 
