...
Similar findings have been shown from the analysis of observations at other locations [@Schwarz2020; @Ohvril2009; @Zerefos2009; @Xia2007] [and references therein].  In the Mediterranean region aerosols have been recognized as an important factor affecting the penetration of solar radiation at the surface [@Fountoulakis2016; @Siomos2018; @Gkikas2013; @Lozano2021]. These studies investigated the long-term trend in aerosol optical depth, which has been found to decrease in the last three decades, the transport and composition of aerosols, and their radiative effects. 
...
near the city center, thus we expect that measurements are affected by the urban environment, mainly by aerosols.
...
identification algorithm (CSid), which is discussed in sect. \ref{CDIDalgorithm}. 
It is noted
