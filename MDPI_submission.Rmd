...
abstract: |
  ...
  Under all three sky categories the SDR trend is stronger in winter with $0.7$, $0.4$ and $0.76\,\%/\text{year}$, respectively for all-, clear- and cloudy-skies. In automn, there are the next larger trends of $0.42$ and $0.19\,\%/\text{year}$, for all- and cloudy-skies respectively. 
  The rest seasonal trends are significant smaller, close to zero, with clear- and cloudy-skies having a negative trend for summer.
...
The attenuation
of SDR by aerosols over Europe have been proposed as major factor by @Wild2021.
