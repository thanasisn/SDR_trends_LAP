...
In Figure\ \ref{fig:trendALL}, we present only the time series under all-sky conditions; the plots for clear-sky and cloud-sky conditions, are shown in Appendix (Figures\ \ref{fig:trendCLEAR} and\  \ref{fig:trendCLOUD}).
...
Although the year-to-year variability of the anomalies (Figure \ref{fig:trendALL} and Figures\ \ref{fig:trendCLEAR} and \ref{fig:trendCLOUD} in Appendix) shows a rather homogeneous behavior, plots of the cumulative sums (CUSUM) [@Regier2019] of the anomalies can reveal different structures in the records of all three sky conditions.
