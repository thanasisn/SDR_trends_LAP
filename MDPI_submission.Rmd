...
Under clear skies (Figure\ \ref{fig:szatrends-2}), the trends are smaller and less variable,
...
For cloudy-sky conditions (Figure\ \ref{fig:szatrends-3}), we cannot discern any significant dependence of the SDR trend with SZA as the variability of irradiance is
...
Table\ \ref{tab:trendseasontable} contains also the $2\sigma$ standard error, the Pearson's correlation coefficient R and the corresponding p-value.
The winter linear trends exhibit generally the largest R values ranging between $0.54$ and $0.60\,\%/y$. 
<!-- all sky -->
...
optical thickness. 
<!-- clear sky -->
In other seasons the clear-sky trend is very small
(below $0.1\,\%/y$). 
<!-- cloud dsky -->
Finally, for cloudy-skies the
