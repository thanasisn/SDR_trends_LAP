...
abstract: |
  ...
  We have found that for all-sky and clear-sky conditions the SDR trend is positive in winter (0.7 and 0.8 %/y, respectively) and autumn (~0.4 %/y), while under cloudy skies the trend is negative (-0.9 %/y in winter and -0.4 %/y in autumn). 
