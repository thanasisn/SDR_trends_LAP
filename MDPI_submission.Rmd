...
dataavailability: |
  Data as daily sums are available through the WRDC database \url{http://http://wrdc.mgo.rssi.ru}.
...
{\centering \subfloat[All skies.\label{fig:szatrends-1}]{\includegraphics[width=.32\linewidth]{./images/SzaTrends-1} }\subfloat[Clear skies.\label{fig:szatrends-2}]{\includegraphics[width=.32\linewidth]{./images/SzaTrends-4} }\subfloat[Cloudy skies.\label{fig:szatrends-3}]{\includegraphics[width=.32\linewidth]{./images/SzaTrends-7} }
