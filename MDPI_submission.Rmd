...
abstract: |
  ...
  We have found that for all conditions the SDR trend is stronger in winter ($0.7$, $0.4$ and $0.76\,\%/\text{year}$, for all- clear- and cloudy skies respectively). For all- and cloudy-skis, in autumn there are the next larger trends ($0.42$ and $0.19\,\%/\text{year}$, respectively), the rest cases bare a negligable seasonal trend. 
  The SDR trend is increasing with increasing solar zenith angle (SZA) for all-skies, from about $0.2$ to $0.6\,\%/\text{year}$. For clear- and cloudy-skies remains low, about $0.1$ -- $0.2\,\%/\text{year}\,\%/\text{year}$ for all SZAs below $\sim 75^\circ$, and rizes rapidly for the larger SZAs.
...
<!-- Trends Global -->
On global scale, artificial Intelligence aided spatial analysis on continental level with data from multiple stations reach similar conclusions for these regions and for the global trend [@Yuan2021].
...
These parameters, were produced by an iterative process, as the original authors proposed, and are discussed in the next section.
