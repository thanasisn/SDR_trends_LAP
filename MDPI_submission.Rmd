...
near the city centre thus we expect that measurements are affected by the urban environment, mainly by aerosols.
...
very small suggesting a small effect from aerosols and water vapour which
...
the CUSUMs of the anomalies to have a symmetric 'V' shape centred
...
CUSUMs for cloudy-skies (Figure\ \ref{fig:cusummonth-3}), show a similar behaviour with some short-term
...
We have analysed a 30-year dataset of SRD measurements in Thessaloniki Greece 
