...
```{r trendseasontable, echo=F, fig.pos='!h'}
...
\begin{figure}[h!]
    ...
    \end{adjustwidth}
    \caption{Time serries of monthly mean anomalies of SDR by season (rows of plots) for the three sky conditions (columns of plots). The black lines represent the linear trends, (a-c) winter}\label{fig:seasonalALL}
\end{figure}
