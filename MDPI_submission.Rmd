...
These are presented in Table\ \ref{tab:trendtable} which contains also the $2\sigma$ standard error, the Pearson's correlation coefficient R and the trend in absolute units.
...
Although the year-to-year variability of the anomalies (Figure \ref{fig:trendALL} and Figures\ \ref{fig:trendCLEAR}, \ref{fig:trendCLOUD} in Appendix), shows a rather homogeneous behavior, plots of the cumulative sums (CUSUM) [@Regier2019] of the anomalies can reveal different structures in the records of all three sky conditions.
